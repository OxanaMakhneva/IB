...
DATES = ()
TABLE_ATTR = TabTableAttr("Типы ТС", "тип с ID: ", "ttypes", "id", "id", 0)
#Дополнительное окно
#Словарь для управления взаимодействием между связанными таблицами (каждая строчка соответствует таблице вкладки)
RELS_DICT = {
"ttypes":        RelField(type = "OneTab-NoBag", table_tab = "ttypes", pkey_tab = "id", pkey_tab_idx = 0,  table_bag = "ttypes", pkey_bag = "id", pkey_bag_idx = 0),
}
#Список для хранения основных данных по таблмцам вкладок
TABS_LIST = (
TabModels(models = {}, relfield = RELS_DICT["ttypes"], table_name = "ttypes", tab_name = "Типы ТС", map_list = mapper_lists["ttypes"], permissions = ("r", "w", "s"), filter_str = "", filter_id = []),
)
