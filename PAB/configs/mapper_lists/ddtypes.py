...
DATES = ()
TABLE_ATTR = TabTableAttr("Типы событий", "тип с ID: ", "ddtypes", "id", "id", 0)
#Дополнительное окно
#Словарь для управления взаимодействием между связанными таблицами (каждая строчка соответствует таблице вкладки)
RELS_DICT = {
"ddtypes": RelField(type = "OneTab-NoBag", table_tab = "ddtypes", pkey_tab = "id", pkey_tab_idx = 0,  table_bag = "ddtpes", pkey_bag = "id", pkey_bag_idx = 0),
}
#Список для хранения основных данных по таблмцам вкладок
TABS_LIST = (
TabModels(models = {}, relfield = RELS_DICT["ddtypes"], table_name = "ddtypes", tab_name = "Типы событий", map_list = mapper_lists["ddtypes"], permissions = ("r", "w", "s"), filter_str = "", filter_id = []),
)
