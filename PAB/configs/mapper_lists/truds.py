...
DATES = ()
TABLE_ATTR = TabTableAttr("Трудовые статусы", "статус с ID: ", "truds", "id", "id", 0)
#Дополнительное окно
#Словарь для управления взаимодействием между связанными таблицами (каждая строчка соответствует таблице вкладки)
RELS_DICT = {
"truds":        RelField(type = "OneTab-NoBag", table_tab = "truds", pkey_tab = "id", pkey_tab_idx = 0,  table_bag = "truds", pkey_bag = "id", pkey_bag_idx = 0),
}
#Список для хранения основных данных по таблмцам вкладок
TABS_LIST = (
TabModels(models = {}, relfield = RELS_DICT["truds"], table_name = "truds", tab_name = "Трудовые статусы", map_list = mapper_lists["truds"], permissions = ("r", "w", "s"), filter_str = "", filter_id = []),
)
