...
DATES = ()
TABLE_ATTR = TabTableAttr("Типы объектов", "тип с ID: ", "atypes", "id", "id", 0)
#Дополнительное окно
#Словарь для управления взаимодействием между связанными таблицами (каждая строчка соответствует таблице вкладки)
RELS_DICT = {
"atypes":  RelField(type = "OneTab-NoBag", table_tab = "atypes", pkey_tab = "id", pkey_tab_idx = 0,  table_bag = "atypes", pkey_bag = "id", pkey_bag_idx = 0),
}
#Список для хранения основных данных по таблмцам вкладок
TABS_LIST = (
TabModels(models = {}, relfield = RELS_DICT["atypes"], table_name = "atypes", tab_name = "Типы объектов", map_list = mapper_lists["atypes"], permissions = ("r", "w", "s"), filter_str = "", filter_id = []),
)
